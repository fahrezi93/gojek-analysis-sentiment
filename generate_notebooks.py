...
def create_notebook(filename, num_classes, data_path, class_names):
    ...
    cells = [
        ...
        },
        {
            ...
            "source": [
                ...
                "    warmup_ratio=0.1,\n",
                "    evaluation_strategy=\"epoch\",     # Check val every epoch\n",
        ...
        },
        {
            ...
            "source": [
                ...
                "\n",
                "print(classification_report(y_true, y_preds, target_names=list(id2label.values())))\n",
                "\n",
                "# Plot CM\n",
...
if __name__ == "__main__":
    # Update these paths to the actual FINAL files created
