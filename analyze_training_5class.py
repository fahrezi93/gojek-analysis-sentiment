...
with open(r'd:\Skripsi\sentiment-analyst-ojol-review\results_5class\checkpoint-4530\trainer_state.json', 'r') as f:
    data = json.load(f)
...
print("=== TRAINING SUMMARY (5-Class) ===\n")
...
ax1.set_ylabel('Loss')
ax1.set_title('Training & Validation Loss (5-Class)')
ax1.legend()
ax1.grid(True)
...
ax2.set_title('Validation Accuracy (5-Class)')
ax2.legend()
ax2.grid(True)
...
print("\n✅ Training history plot saved as 'training_history_5class.png'")
